...
fun Catalogopeli(modifier: Modifier = Modifier) {
    ...
    // Función para navegar a PantallaUnida
    val navigateToPantallaUnida = {
        val intent = Intent(context, PantallaUnida::class.java)
    ...
    Box(
        ...
        Box(
            modifier = Modifier
                ...
                .clickable { navigateToPantallaUnida() }
        ) {
            Image(
